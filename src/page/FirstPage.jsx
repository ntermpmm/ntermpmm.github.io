    ...
    return (
        <>
            <div className="relative">
                <div className="">
                    {/* =================Section1==================== */}
                    <div id="HomePage" className=" child flex-col gap-12">
                        <NavHome />
                        <div className="bg-[#F4F3FE] p-20 pt-12 rounded-3xl flex flex-col gap-16   text-center">
                    ...
                    {/* ================= Hello! I’m==================== */}
                    <div className="child flex flex-col gap-20">
                    ...
                    {/* =================Contact==================== */}
                    <div className="child flex-col gap-12">
                        {" "}
