    ...
    return (
        ...
        >
            <div className="flex flex-col gap-8">
                <nav className=" mt-12  flex  items-center justify-around ">
                ...
                <div className="h-screen">
                    <div className=" bg-[#F4F3FE] w-[1432px] h-[740px] rounded-xl  max-w-screen-2xl  mx-auto ">
                        <div className=" flex items-start gap-24 p-24 py-32">
                            <div className="flex flex-col gap-8">
                                <div className=" text-[64px] w-[362px] text-[#322A3C] leading-[120%] font-bold">
                                    I’m Term{" "}
                                ...
                                <div className=" text-[20px] text-[#50555C] w-[362px]">
                                    The quick, brown fox jumps over a lazy dog.
                                    DJs flock by when
                                </div>
                            </div>
                            <div className="flex  w-full gap-16">
                                <div className="w-[348px] group h-[488px]  hover:w-[388px] hover:h-[576px] hover:-mt-12  hover:bgHomeEl relative bg-white  flex flex-col gap-4 justify-end rounded-xl duration-200">
                                    <img
                                        src={BgLaptop}
                                    ...
                                    {/* <div className=" text-[#52555A] flex flex-col ">
                                    ...
                                    <div className=" border border-[#6555DF] text-center rounded-full p-4 text-[#6555DF] ">
                                        View More
                                    </div> */}
                                    <div className=" p-8 flex flex-col gap-4 z-10">
                                        ...
                                        <div className=" group-hover:text-[#fff] group-hover:bg-[#C5BFF3]  border border-[#6555DF] text-center rounded-full p-4 text-[#6555DF] ">
                                            View More
                                        </div>
                                    </div>
                                </div>
                                ...
                                {/* <div className="w-[388px] h-[576px] bgHomeEl relative -mt-12  p-8 flex flex-col gap-4 justify-end rounded-xl">
                                    <div className="  ">
                                        <img
                                            src={laptop}
                                    ...
                                    <div className=" text-center rounded-full p-4 text-[#fff] bg-[#C5BFF3] ">
                                        View More
                                    </div>
                                </div> */}
                            </div>
            ...
            <div className="flex flex-col gap-52">
                <div className="max-w-screen-2xl mx-auto">
                    ...
                    <div className="  mx-auto  flex flex-col gap-28">
                        ...
                        <div className="flex flex-col lg:gap-52 gap-24 left-0  right-0 items-center max-w-screen-xl">
                            <div
                ...
                <div className=" flex flex-col gap-12">
                    <div>
                        <div
                            data-aos="fade-up"
                            className=" max-w-screen-xl mx-auto text-[#322A3C] lg:text-[56px] text-4xl lg:mt-8 md:text-5xl mt-0 text-center md:text-left md:mt-4  font-bold opacity-50"
                        >
                            Recent Features
                        </div>
                    </div>
                    <div className=" w-full bg-[#F4F3FE]">
                        <div className="grid text-center max-w-screen-xl mx-auto py-12  items-center gap-12">
                ...
                <div className=" max-w-screen-xl mx-auto flex flex-col gap-48">
                    <div className="flex flex-col gap-12">
                    ...
                    <div className="bg-[#F4F3FE] rounded-xl">
                        <div className=" grid grid-cols-2 items-center px-16 p-12 gap-16">
                            <div className=" flex flex-col gap-8">
                                ...
                                <div className=" text-[20px] text-[#50555C]">
                    ...
                    <div className="grid text-left items-center relative lg:mt-0 mt-16 gap-16">
                        <div
                            data-aos="fade-up"
